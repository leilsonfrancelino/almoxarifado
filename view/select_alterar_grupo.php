...
if ($_GET['id'] == "") {
  ...
  <head>
    ...
    <title>Alteração de Grupo</title>
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Alteração de grupo</li>
          </ol>

          <!--Formulario-->
          <form method="POST" action="../valida/valida_alter_grupo.php">
			...
			<div class="form-row">
              ...
              <div class="form-group">
                ...
                <input type="text" name="novo_nome" class="form-control" id="nome_grupo" value="<?php echo $dados_grupo_selecionado['nome'] ?>">
