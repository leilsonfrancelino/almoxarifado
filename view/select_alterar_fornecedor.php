    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <!--Formulario-->
          <form method="POST" action="../valida/valida_alter_fornecedor.php">
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="novo_nome" class="form-control" id="nome_fornecedor" value="<?php echo $dados_fornec_selecionado['nome'] ?>">

              </div>
              <div class="form-row">
                <div class="form-group col-md-4">
                  <label for="inputEmail4">Cnpj:</label>
                  <input type="text" name="novo_cnpj" class="form-control" id="cnpj" value="<?php echo $dados_fornec_selecionado['cnpj'] ?>">
                </div>
                <div class="form-group col-md-4">
                  <label for="tipo_produto">UF (Sigla):</label>
                  <input type="text" name="novo_uf" class="form-control" id="uf" value="<?php echo $dados_fornec_selecionado['uf'] ?>">
                </div>
				<div class="form-group col-md-4">
        ...
        <div class="modal-footer">
		  ...
		  <a href="lista_fornecedores.php" style="width:15%" type="button" class="btn btn-secondary" data-dismiss="modal">Voltar</a>
