  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!--Formulario-->
        <form method="POST" action="../valida/valida_cadastro_produto.php">
          <div class="modal-body">
		  
		  <!-- select do código -->
              <?php
              require "../dao/conexao.php";
              $sql = "SELECT codigo FROM produtos ORDER BY codigo DESC LIMIT 1";
            ...
            <div class="form-row">
			  ...
			  <div class="form-group col-md-6">
				...
				<div class="form-group col-md-6">
                <label for="data">Grupo:</label>
                <select class="form-control" value="" name="select_grupo" id="select_serv" required>
                  <option value="" selected required>Selecione...</option>
                  <?php
